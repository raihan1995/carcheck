  ...
  if (variant === "compact") {
    return (
      ...
      >
        ...
        />
        <circle cx="9" cy="20" r="1" fill="currentColor" className="text-foreground" />
        <circle cx="14" cy="16" r="1" fill="currentColor" className="text-foreground" />
        <circle cx="20" cy="16" r="1" fill="currentColor" className="text-foreground" />
        <circle cx="23" cy="20" r="1" fill="currentColor" className="text-foreground" />
        {/* Checkmark */}
        <defs>
  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <circle cx="36" cy="34" r="2.5" fill="#e2e8f0" />
      <circle cx="52" cy="24" r="2.5" fill="#e2e8f0" />
      <circle cx="80" cy="20" r="2.5" fill="#e2e8f0" />
      <circle cx="108" cy="24" r="2.5" fill="#e2e8f0" />
      <circle cx="124" cy="34" r="2.5" fill="#e2e8f0" />
      {/* Orange checkmark */}
      <path
